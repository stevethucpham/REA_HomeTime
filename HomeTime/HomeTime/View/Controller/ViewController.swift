...
extension ViewController {
  ...
  func loadTramData() {
    loadingNorth = true
    loadingSouth = true
    let tramService = TramService()
    let northStopId = "4055"
    tramService.loadTramDataUsing(stopId: northStopId) { [weak self] (result) in
        switch result {
...
//    let northStopId = "4055"
//        tramService.loadTramDataUsing(stopId: northStopId) { (result) in
//            switch result {
//            case .success(let trams):
//                self.northTrams = trams
//                self.tramTimesTable.reloadData()
...
////      }
//        
//        tramService.fetchApiToken { (result) in
//            switch result {
